...
class CalcViewController: FormViewController {
    ...
    let numero_lampadine      = 10.0
    let ore_giornaliere       = 8.0
    let anno                  = 0.365
    let costo_elettrico_medio = 0.22 // €/KWh
    ...
    override func viewDidLoad() {
        ...
        form +++ Section("Puoi utilizzare un dispositivo LED con potenza compresa tra")
        ...
        form +++ Section(
            "Risparmio annuo approssimato per \(String(format: "%.0f", numero_lampadine)) lampade LED accese per \(String(format: "%.0f", ore_giornaliere)) ore al giorno con un costo dell'energia elettrica medio di \(costo_elettrico_medio)€/KWh"
            )
        ...
        form +++ Section(
            "Le formule utilizzate sono tratte dagli studi degli scienziati della Lawrence Berkeley Laboratory sullo spettro luminoso"
            )
